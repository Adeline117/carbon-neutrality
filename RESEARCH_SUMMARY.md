...
| 5 | 价格质量反馈环 | 价格数据与质量指标合并，Granger 因果检验 | 828 天价格 | r=0.774, 双向因果 |
...
| 12 | 34 段质量图谱 | VCM 全市场按类型×地区×年份分段 | 318 信用 | PQD 范围 0.076 到 0.759 |
| 13 | 权重敏感性 | Dirichlet 扰动 10,000 组权重 | 29 信用×10k 次 | 93.7% 等级不变 |
| 14 | 时间趋势分解 | 全量 vs 去年份维度的偏相关 | 1,187 笔，932 有年份 | 全量 ρ=-0.24, 去年份 ρ=+0.24 |
| 15 | 福利损失估计 | Monte Carlo 模拟搁浅的社会成本 | 10,000 次模拟 | $1.46 亿（90% CI $0.68 到 2.52 亿）|
...
1. **评分框架是我们自己设计的**，不可避免带有主观判断。三重验证能说明框架跟外部标准一致，但不能证明它就是"正确的"。好在全部评分标准和代码都公开了，别人可以用自己的权重重新算。
...
| 东西 | 情况 |
|------|------|
| 主论文 | ~13,750 词 + 8 图 6 表 44 引用，完稿 |
| 技术标准论文（ERC-CCQR） | 完整版 10,382 词 + 精简版 3,355 词 |
| 评分数据 | 345/345 BCT 代币全覆盖 + 318 个 CCP 校准数据集 |
| 链上数据 | 1,187 存款 + 35,432 赎回 + 708 NCT 存款 + 134 个钱包缓存 |
