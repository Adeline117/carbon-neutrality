...
A chi-squared test of independence ($\chi^2$ = 4.0e6, $p$ $\approx$ 0, df = 1) tested whether renewable credits were redeemed at a different rate than non-renewable credits. The contingency table cross-tabulated renewable/non-renewable status against redeemed/remaining status.
