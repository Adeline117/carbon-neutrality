...
Because every transaction is publicly recorded, the complete ledger supports the first credit-level forensic account of this dynamic, a reconstruction opaque off-chain markets cannot supply. The implication reaches beyond carbon: it covers the \$25-billion-plus sector now tokenizing other real-world assets, and Article 6.4, the UN crediting mechanism under the Paris Agreement, operationalized at COP29 in 2024. Transparency without price differentiation appears insufficient for market function.

\section*{Results}
\subsection*{BCT's real composition contradicts the REDD+ narrative}

The 1,187 deposits span 168 unique Verra VCS (Verified Carbon Standard) projects and about 22 million tonnes (Methods).
