...
\begin{abstract}
Policymakers widely assume that making carbon credit quality visible will prevent low-quality credits from dominating trade. Here, we show this assumption is wrong. We reconstruct every transaction in the largest pooled carbon credit market (22 million tonnes) and find that it collapsed despite full transparency: everyone could see which credits were worthless, yet the market still filled with them. The cause was not hidden information but design --- the pool sold every credit at the same price regardless of quality, so participants could not act on what they saw. Informed buyers exploited this flaw, extracting \$4--\$8 million in high-value credits while 9.6 million tonnes of low-quality credits remain permanently stranded. Contrary to prevailing narratives, the collapse was driven by wind and solar credits with near-zero climate benefit (69.1\% of content), not forest conservation credits (4.2\%). Comparing identical credits in two pools with different rules, we find the same credits were fully extracted from the unscreened pool but mostly retained in the quality-screened one --- market design, not credit type, determines asset fate. This transparency paradox carries direct implications for carbon trading systems now being designed under the Paris Agreement.
\end{abstract}
