...
\begin{abstract}
A dominant assumption in climate policy holds that making carbon credit quality transparent will prevent low-quality credits from dominating markets. Here, we test this assumption using the first complete forensic reconstruction of a carbon market collapse, analysing every transaction (22 million tonnes, 1,187 deposits, 35,432 withdrawals, 28,897 accounts) in the largest pooled carbon credit market. Despite full public transparency of every credit's quality metadata, the market collapsed: 69.1\% of pool content consisted of renewable energy credits with near-zero additionality (the requirement that emission reductions would not have occurred without carbon revenue), not forest conservation credits (4.2\%) as widely claimed. Two nearly separate populations (1.4\% overlap) operated on opposite sides: sellers deposited credits indiscriminately, while informed buyers selectively extracted credits that retained value elsewhere, earning an estimated \$4--\$8 million. A natural experiment comparing identical credits across two pools with different quality screens confirms that market design, not credit type, determines asset fate. The reason transparency failed is architectural: the pool's uniform pricing prevented participants from acting on the quality information they could plainly see. This transparency paradox --- quality collapse under full observability --- carries direct implications for the carbon trading systems now being designed under the Paris Agreement.
\end{abstract}
