...
A second, independent integrity problem affects how much these same credits claim per unit. An illustrative satellite-based cross-check of 28 Indian CDM renewable energy projects in the BCT pool, comparing country-level CDM-claimed emission factors (the amount of CO$_2$ assumed to be displaced per unit of electricity generated) against Ember's observed grid emission factors for the same vintage years, reveals a mean overclaim of 26.5\% (range 23.6--28.8\%; aggregate claimed 3.39 million tCO$_2$ versus 2.70 million tCO$_2$ consistent with observed grid data; see Supplementary Methods). That is, even setting additionality aside, the per-unit reductions were systematically overstated. A separate Sentinel-5P TROPOMI (a satellite instrument measuring atmospheric methane from space) methane-column analysis of 9 BCT waste/methane projects found 5 of 9 (56\%) with site-level methane concentrations not significantly below background, though TROPOMI spatial resolution (5.5 km) limits project-level attribution. Additionality and quantification are distinct failures; here they compound.
