...
\begin{itemize}
\item \textbf{Cross-pool arbitrage (39.2\%)}: deposited into Toucan's NCT (Nature Carbon Tonne) pool, a quality-screened counterpart to BCT, exploiting the price differential between BCT's uniform pricing and NCT's nature-based premium.
