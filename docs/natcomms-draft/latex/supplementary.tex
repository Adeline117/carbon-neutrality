...
\title{Supplementary Information\\[0.5em]\large Adverse selection in tokenized carbon markets: who profited from the first pool collapse}
\author{Adeline Wen \& Wei Cai\\\\
\small Decentralized Computing Laboratory, University of Washington Tacoma\\\\
\small Correspondence: weicaics@uw.edu}
\date{}
...
\subsection*{Pool Quality Deficit}
...
1. \textbf{Terra/LUNA collapse}: May 9, 2022 (approximate Polygon block 28,400,000), when the UST algorithmic stablecoin lost its peg, triggering a broad DeFi liquidity crisis.
2. \textbf{FTX collapse}: November 6, 2022 (approximate Polygon block 35,200,000), when the FTX exchange filed for bankruptcy.
...
\subsection*{Vintage-free robustness check}
...
\subsection*{Depositor-level analysis}
...
\subsection*{Account forensics and quality swap analysis}
...
\subsection*{Rank correlation with commercial rating agencies}
...
\subsection*{34-segment quality atlas}
...
\subsection*{Supplementary Table 1. Temporal quartile analysis of BCT deposit quality.}
...
\subsection*{Satellite verification of BCT credit quality}
...
\subsection*{Supplementary Table 2. Vintage-free robustness check: temporal correlation with and without vintage dimension.}
