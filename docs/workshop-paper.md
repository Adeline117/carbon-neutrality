...
**Assumption 2 — Co-benefit narratives should not inflate quality grades (safeguards-gate).** We dropped co-benefits from a 10% weighted dimension to a 0%-weight informational field with a `communityHarm` disqualifier gate. This was driven by one empirical finding (Berg et al. 2025: buyers pay 2x for narrative regardless of integrity). The alternative — keeping co-benefits as a scored dimension — is defensible if one believes that projects delivering verified SDG outcomes genuinely *are* higher quality carbon credits, not just better-marketed ones. Our framework does not distinguish between genuine SDG outcomes and SDG narratives, which is a limitation.
